...
class _ExperimanetDashBoardScreen extends State<ExperimanetDashBoardScreen>{
  ...
  Widget makeExperiment({experimentID, userImage="assets/images/unknown_user.jpg", feedTime, feedText, feedImage}) {
                ...
                Row(
                  children: <Widget>[
                    ...
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[
                        Text(experimentID, style: TextStyle(color: Colors.grey[900], fontSize: 18, fontWeight: FontWeight.bold, letterSpacing: 1),),
                        SizedBox(height: 10,),
